...
public class SecurityConfigurations extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		authorizeRequests().antMatchers(HttpMethod.GET, "/api/pedidos").hasAnyAuthority("ADMIN")
				.antMatchers(HttpMethod.POST,"/api/encriptado").permitAll()
				.antMatchers(HttpMethod.POST,"/api/clientes").permitAll()
				.antMatchers(HttpMethod.GET, "/topicos/*").permitAll().antMatchers(HttpMethod.POST, "/api/auth").permitAll()
