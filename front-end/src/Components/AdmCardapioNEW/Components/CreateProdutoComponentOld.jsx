...
import EmployeeService from '../../../services/ProdutoService';
                            ...
                            <div className="card-body">
                                <form >
                                    <div className="form-group ">
                                        ...
                                        <input required placeholder="Nome Produto" name="nome" className="form-control"
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input placeholder="Descricão Produto:" name="descricao" className="form-control"
                                            value={this.state.descricao} onChange={this.changedescricaoHandler} />
                                    </div>

                                    <div className="form-group">
                                        <label >Preço Produto</label>
                                        <input placeholder="Preço Produto" name="preco" className="form-control"
                                            value={this.state.preco} onChange={this.changeprecoHandler} />
                                    </div>
                                    <div className="form-group">
                                        <label >Categoria Produto</label>
                                        <select className="form-control col-12 " onChange={this.changeTipoProdutoHandler}>
