...
import xyz.paladarpastel.backend.api.exceptionhandler.Problem.Field;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String detail = "O corpo da requisição esta invalida, verifique a sintaxe";
	...
	private ResponseEntity<Object> HandleInvalidFormat(InvalidFormatException ex, HttpHeaders headers,
		...
		String detail = String.format(
				"A propriedade '%s' recebeu o valor '%s', que é do tipo inválido. Corriga e informe um valor compatível com o tipo %s.",
	...
	@ExceptionHandler(EntidadeNaoEncotradoException.class)
	public ResponseEntity<?> handleEntidadeNaoEncotrado(EntidadeNaoEncotradoException ex, WebRequest request) {
	...
	public ResponseEntity<?> handleEntidadeJaExiste(EntidadeJaExisteException ex, WebRequest request) {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		Problem problem = createProblemBuilder(status, problemType, detail).fields(fields).build();
	...
	private Problem.ProblemBuilder createProblemBuilder(HttpStatus status, ProblemType problemType, String detail) {
		...
		return Problem.builder().detail(detail).status(status.value()).title(problemType.getTitle())
